...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['editProfile'])) {
    ...
    // Initialize file paths for photos
    $profilePhotoPath = $user['profilePicture']; // Default to existing photo
    $backgroundPhotoPath = $user['coverPhoto']; // Default to existing photo
    ...
    if (isset($_FILES['backgroundPhoto']) && $_FILES['backgroundPhoto']['error'] == 0) {
        ...
        // Validate file type for background photo
                    ...
                    <div class="modal-content" style="background-color: #f8f9fa;">
                        ...
                        <div class="modal-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" class="btn btn-primary w-100" name="editProfile">Save Changes</button>
                            </form>
                        </div>
                    </div>
                </div>
