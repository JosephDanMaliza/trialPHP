                ...
                <div class="profile-container col-md-12">
                    <div class="profile-section position-relative">
                        <div class="background">
                            <img src="../assets/imgs/pfp.jpg" alt="Background Picture">
                        </div>
                        ...
                        <div class="profile-info">
                            <div class="profile-data">
                                <h1 class="fullname mt-3">John Doe</h1>
                                <h2 class="username">@jdoe</h2>
                                <p class="followers">100 followers</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="backgroundPhoto" accept=".png, .jpg">
                                </div>
                                <div class="mb-3">
                                    <label for="profilePhoto" class="form-label">Profile Photo</label>
                                    <input type="file" class="form-control" id="profilePhoto" accept=".png, .jpg">
                                </div>
                                <div class="mb-3">
